...
const StartScreen: React.FC<StartScreenProps> = ({ onStart }) => {
  ...
  return (
    <div className="absolute inset-0 flex flex-col items-center justify-center z-50 text-white font-sans p-6 bg-slate-950 transition-all duration-1000">
      <div className="max-w-md w-full bg-slate-900 p-8 rounded-2xl border border-slate-700 shadow-2xl relative overflow-hidden animate-fade-in">
        ...
        <div className="relative z-10">
            ...
            <div className="bg-slate-800 p-5 rounded-xl border border-slate-700 mb-8 hover:border-slate-600 transition-colors shadow-inner">
            ...
            className="w-full py-4 bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500 text-white font-bold rounded-xl shadow-lg transform transition-all hover:scale-[1.02] active:scale-[0.98] text-lg tracking-wide"
            >
            Start Building
            </button>
